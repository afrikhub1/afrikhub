        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($residences as $residence)
                @php
                    ...
                    $reservationEnCours = $residence->reservations->whereIn('status', ['confirmée', 'payé', 'suspendu'])->first();
                @endphp
                    ...
                    <div class="p-6 flex flex-col flex-grow border-gray-700/50 shadow">
                        ...
                        <ul class="space-y-2 text-sm text-gray-700 mb-4 flex-grow">
                            ...
                            <li class="flex justify-between items-center">
                                ...
                                <span class="{{ $residence->disponible == 0 ? 'text-red-600 font-semibold' : 'text-green-600 font-semibold' }}">
                                    {{ $residence->disponible == 0 ? 'Indisponible' : 'Disponible' }}
                                </span>
                            </li>
                        </ul>
