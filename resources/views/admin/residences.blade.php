                ...
                @foreach($residences as $residence)
                    ...
                    <div class="search-row  bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col
                        ...
                        <div class="p-6 flex flex-col flex-grow border-gray-700/50 shadow">
                            <p class=" font-extrabold text-indigo-800 mb-2 border-b border-gray-100 pb-2 truncate">{{ $residence->nom }} - {{ $residence->id }}</p>
                            ...
                            <div class="mt-4 border-t pt-4">
                                ...
                                <div class="flex flex-wrap justify-start gap-2">
                                    ...
                                    <a href="{{ route('admin.demande.valider', $residence->id) }}" class=" px-3 py-1.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-medium">
