                            ...
                            <div class="mt-4 border-t pt-4">
                                ...
                                <div class="flex flex-wrap justify-start gap-2">
                                    ...
                                    <form action="{{ route('admin.residences.sup', $residence->id) }}" method="POST">@csrf @method('DELETE')
                                        <button type="submit" class="text-sm px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium" onclick="return confirm('Êtes-vous sûr ?')">
