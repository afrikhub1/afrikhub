...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 flex-shrink-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 md:block transition-transform duration-300 transform -translate-x-full md:translate-x-0 no-scrollbar overflow-y-auto">
        ...
        <nav class="flex-1 p-4 space-y-2">
            <a href="#" class="flex items-center p-3  font-medium text-white bg-primary dark:bg-primary-dark rounded-lg shadow-md hover:bg-primary-dark dark:hover:bg-primary transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                Aperçu Général
            </a>
            <a href="{{ route('admin.residences') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            ...
            <a href="{{ route('admin.reservations') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            ...
            <a href="{{ route('admin.utilisateurs.all') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            ...
            <a href="{{ route('admin.demande.interruptions') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20v-2a3 3 0 00-5.356-1.857M17 20H7m0 0a3 3 0 01-5.356-1.857M7 20v-2a3 3 0 01-5.356-1.857m0 0H2"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 9a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                Demandes d'interruption
            </a>
            <a href="{{ route('publicites.index') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20v-2a3 3 0 00-5.356-1.857M17 20H7m0 0a3 3 0 01-5.356-1.857M7 20v-2a3 3 0 01-5.356-1.857m0 0H2"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 9a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                Publicites
            </a>
            <a href="{{ route('carousels.index') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20v-2a3 3 0 00-5.356-1.857M17 20H7m0 0a3 3 0 01-5.356-1.857M7 20v-2a3 3 0 01-5.356-1.857m0 0H2"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 9a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                Pub carrousel
            </a>
            <a href="{{ route('file.manager') }}" class="flex items-center p-3  font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            ...
            <a href="{{ route('news.letter') }}" class="flex items-center p-3 font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <!-- SVG Newsletter -->
                <svg class="w-5 h-5 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/50 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class=" font-medium text-gray-500 dark:text-gray-400">Revenus du Mois</p>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/50 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class=" font-medium text-gray-500 dark:text-gray-400">Taux Occupation</p>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/50 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class=" font-medium text-gray-500 dark:text-gray-400">Réservations</p>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/50 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class=" font-medium text-gray-500 dark:text-gray-400">Résidences Actives</p>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                            <td class="px-4 py-4 whitespace-nowrap  font-medium text-gray-900 dark:text-white">{{ $residence->nom }}</td>
                            <td class="px-4 py-4 whitespace-nowrap  text-gray-500 dark:text-gray-400">{{ $residence->ville }}, {{ $residence->pays }}</td>
                                ...
                                <div class="flex space-x-2 items-center">
                                    ...
                                    @if ($residence->status === 'vérifiée')
                                        ...
                                        <form action="{{ route('admin.residences.desactivation', $residence->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" class=" px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium"
