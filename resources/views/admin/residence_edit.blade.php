    ...
    <form action="{{ route('admin.residences.update', $residence->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-xl shadow-2xl border border-gray-100">
        ...
        <fieldset class="border border-gray-300 p-4 rounded-lg mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Nom de la Résidence --}}
                <div>
                    <label for="nom" class="block text-sm font-medium text-gray-700 mb-1">Nom de la Résidence</label>
                ...
                {{-- Prix Journalier --}}
                <div>
                    <label for="prix_journalier" class="block text-sm font-medium text-gray-700 mb-1">Prix Journalier (FCFA)</label>
        ...
        <fieldset class="border border-gray-300 p-4 rounded-lg mb-8">
            ...
            <div class="mb-4">
                <label for="img_upload" class="block text-sm font-medium text-gray-700 mb-1">Téléverser de Nouvelles Images (Optionnel)</label>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    @empty
                        <p class="text-sm text-gray-400">Aucune image enregistrée.</p>
                    @endforelse
                </div>
            </div>
        </fieldset>
