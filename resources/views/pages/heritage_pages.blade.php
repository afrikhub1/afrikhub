    ...
    <header class="bg-gray-900 shadow-lg fixed top-0 left-0 right-0 z-40">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-between text-center border-t border-gray-800 py-2 -mx-4">
                ...
                <a href="{{ route('pro.residences') }}" class="flex-1 min-w-[20%] p-2 text-gray-300 hover:bg-gray-800 rounded-lg">
                    <i class="fas fa-home mr-1"></i> Résidences
                    <span class="ml-1 px-2 bg-red-600 text-xs font-bold rounded-full">{{ $totalResidences }}</span>
                </a>

                <a href="{{ route('occupees') }}" class="flex-1 min-w-[20%] p-2 text-gray-300 hover:bg-gray-800 rounded-lg">
                ...
                <a href="{{ route('mes_demandes') }}" class="flex-1 min-w-[20%] p-2 text-gray-300 hover:bg-gray-800 rounded-lg">
                ...
                <a href="{{ route('reservationRecu') }}" class="flex-1 min-w-[20%] p-2 text-gray-300 hover:bg-gray-800 rounded-lg">
