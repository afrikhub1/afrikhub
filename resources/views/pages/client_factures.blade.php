...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto p-2 py-12">
        ...
        <div class="flex justify-center space-x-4 mb-8 border-b pb-4">
            {{-- Utilise la route correcte 'historique' ou 'clients_historique' selon votre configuration --}}
                ...
                <div class="bg-white rounded-xl shadow-xl overflow-hidden flex flex-col border-4
                    ...
                    <div class="p-5 flex flex-col flex-grow text-center">
                        ...
                        <div class="mt-4 flex flex-col gap-2">
                            {{-- Téléchargement du PDF via la route du contrôleur --}}
                            ...
                            @if($factureStatut == 'en_attente')
                                {{-- Paiement via la route du contrôleur --}}
