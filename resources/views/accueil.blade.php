...
<style>
    ...
    nav ul {
        ...
        font-size: clamp(0.75rem, 1vw, 0.85rem); /* modifié */
    }
        ...
        font-size: clamp(16px, 2vw, 20px); /* modifié */
        margin-bottom: 2px;
    }

    #entete .badge {
        font-size: clamp(10px, 1vw, 12px); /* modifié */
    ...
    .sidebar a {
        ...
        font-size: clamp(0.85rem, 1vw, 1rem); /* modifié */
    }
    ...
    .menu-btn {
        font-size: clamp(18px, 2vw, 22px); /* modifié */
        padding: 8px 12px;
        border-radius: 8px;
        cursor: pointer;
        color: white;
    ...
    .sidebar .close-btn {
        ...
        top: 15px;
        right: 15px;
        font-size: clamp(20px, 2.5vw, 24px); /* modifié */
        color: white;
        cursor: pointer;
        padding: 5px;
    ...
    #accueil h2 {
        font-size: clamp(2.5rem, 6vw, 5rem); /* modifié */
        font-weight: 900;
        line-height: 1.1;
    ...
    #accueil span.fs-6 {
        font-size: clamp(1rem, 2vw, 1.25rem); /* modifié */
        font-weight: 400;
        text-shadow: 2px 2px 8px rgba(0,0,0,0.5);
    }

    #hebergement h2 {
        font-size: clamp(2rem, 4vw, 2.8rem); /* modifié */
    }

    .accordion-css label {
        font-size: clamp(0.85rem, 1.2vw, 1rem); /* modifié */
    }

    .accordion-css .services-list li {
        font-size: clamp(0.8rem, 1vw, 1rem); /* modifié */
    }

    .btn-reserver {
        font-size: clamp(0.9rem, 1.5vw, 1.1rem); /* modifié */
    }

    footer {
        font-size: clamp(0.85rem, 1vw, 0.95rem); /* modifié */
    }

    @media (max-width: 768px) {
        #hebergement h2 { font-size: clamp(1.5rem, 4vw, 2rem); /* modifié */ }
        .accordion-button { font-size: clamp(0.9rem, 1vw, 1rem) !important; /* modifié */ }
        .btn-reserver { font-size: clamp(0.9rem, 1.2vw, 1rem); /* modifié */ }
    }
