            ...
            <div class="col-12 row m-0 align-items-center">
                ...
                <div class="col-lg-10 col-md-10 col-9 d-flex justify-content-end align-items-center position-relative">
                    ...
                    <ul id="entete" class="d-flex justify-content-end py-2 m-0">
                        ...
                        <li><a href="#footer"><span class="fa-solid fa-phone"></span><span class="badge">Contact</span></a></li>
                    </ul>
                    ...
                    <div id="sidebar" class="sidebar">
                        ...
                        <a href="#footer"><i class="fa-solid fa-phone"></i>Contact</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="max-w-7xl mx-auto px-4 py-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 border-b border-gray-700 pb-10 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="{{ route('faq') }}" class="text-xs md:text-sm text-white-400 hover:text-white transition block">FAQ</a></li>
                            <li><a href="https://wa.me/2250769480232" class="text-xs md:text-sm text-white-400 hover:text-white transition block">Support Technique</a></li>
                            <li><a href="https://wa.me/2250769480232" class="text-xs md:text-sm text-white-400 hover:text-white transition block">Déposer une annonce</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="{{ route('mentions_legales')}}" class="text-xs md:text-sm text-white-400 hover:text-white transition block">Mentions Légales</a></li>
                            <li><a href="{{ route('politique_confidentialite') }}" class="text-xs md:text-sm text-white-400 hover:text-white transition block">Confidentialité</a></li>
                            <li><a href="{{ route('conditions_generales') }}" class="text-xs md:text-sm text-white-400 hover:text-white transition block">Conditions Générales</a></li>
                        </ul>
                    </div>
                </div>
        
                {{-- Bas de page : Centré sur mobile, espacé sur desktop --}}
                <div class="flex flex-col md:flex-row justify-between items-center text-white-500 pt-8">
