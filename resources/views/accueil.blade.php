...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-Vv9GZq1sI3yV1+XH6lHJbOXxR+aWZ5B14O+YBxO2PS2z+poJ6bQ0Lqz4yd+g9P7e4vl9IVRz7fKtLvOTj8X0Ag==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <style>
        ...
        .dropdown-toggle { color:white; background:transparent; padding:10px 15px; border-radius:50px; font-weight:700; cursor:pointer; text-decoration:none; }
        ...
        .dropdown-menu li a { padding:8px 15px; color:white; font-weight:600; width:100%; margin-top:0; text-align:center; border-bottom:1px solid #b2dfdb; }
        .dropdown-menu li a:hover { background-color:#00b4a2; color:white; }
        .nav-item.dropdown:hover .dropdown-menu, .nav-item.dropdown:focus-within .dropdown-menu { display:flex; }
        @media screen and (max-width:978px) {
            ...
            .dropdown-toggle:focus + .dropdown-menu, .dropdown-toggle:hover + .dropdown-menu { display:flex; }
        }
        ...
        #accueil span { font-size:clamp(1rem,2vw,1.25rem); font-weight:400; text-shadow:2px 2px 8px rgba(0,0,0,0.5); }

        /* Hébergement */
        #hebergement { padding:3rem 1rem; background:#e0f2f1; color:#004d40; border-radius:20px; box-shadow:0 8px 24px rgba(0,0,0,0.15); margin:3rem auto; transition: transform 0.3s, box-shadow 0.3s; }
        ...
        #hebergement img { border-radius:15px; box-shadow:0 8px 18px rgba(0,0,0,0.2); width:100%; height:auto; object-fit:cover; transition: transform 0.3s; }
        #hebergement img:hover { transform:scale(1.05); }
        .accordion-button { background:linear-gradient(135deg,#006d77,#00afb9)!important; color:white!important; font-weight:700; border-radius:12px!important; transition: all 0.3s; }
        .accordion-button:not(.collapsed) { background:linear-gradient(135deg,#004d55,#007f7a)!important; color:#fff; }
        .accordion-body { font-weight:600; color:#004d40; }
        .services-list li { padding:8px 0; transition: transform 0.2s ease, background 0.3s; }
        .services-list li:hover { background: rgba(0,109,119,0.1); transform:translateX(5px); }
        .toggle-services i { transition: transform 0.3s, color 0.3s; }
        .toggle-services:hover i { color:#004d40; }
        .btn-reserver { display:inline-block; padding:12px 28px; font-size:18px; font-weight:bold; color:#fff; background:#007bff; border-radius:30px; text-decoration:none; box-shadow:0 4px 10px rgba(0,0,0,0.2); transition:background 0.3s; animation:bounce 2s infinite; }
...
<header class="p-1">
    <div class="col-12 row m-0 align-items-center">
        <div class="col-lg-2 col-md-2 col-3">
            <img src="{{ asset('assets/images/logo_01.png') }}" alt="Afrik'Hub Logo" class="img-fluid"/>
        </div>
        <nav class="col-lg-10 col-md-10 col-9">
            <ul class="d-flex justify-content-end py-2" id="entete">
                <li><a href="{{ route('login') }}" class="bg-dark"><i class="fa fa-sign-in"></i><span class="badge">connexion</span></a></li>
                <li><a href="{{ route('register') }}" class="bg-dark"><i class="fa fa-user-plus"></i><span class="badge">inscription</span></a></li>
                <li><a href="{{ route('admin.login') }}" class="bg-danger"><i class="fa fa-user-shield"></i><span class="badge">admin</span></a></li>
                <li><a href="#hebergement"><i class="fa fa-home"></i><span class="badge">hébergement</span></a></li>
                <li><a href="#location"><i class="fa fa-car"></i><span class="badge">véhicule</span></a></li>
                <li><a href="#contact"><i class="fa fa-phone"></i><span class="badge">contact</span></a></li>
...
<section id="hebergement" class="my-2 col-12 row m-0 justify-content-center">
    ...
    <div class="row g-4 align-items-center col-12 col-md-8 col-lg-6 mx-4">
        <img src="{{ asset('assets/images/hebergement.jpg') }}" alt="Afrik'Hub Hébergement"/>
    </div>
                        ...
                        <div class="card shadow h-100 border-0 rounded-4 overflow-hidden w-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <ul class="list-unstyled small mb-3 mt-2">
                                    ...
                                    <li><i class="fas fa-couch me-2 text-primary"></i> <strong>Salon :</strong> {{ $residence->nombre_salons ?? '-' }}</li>
                                    ...
                                    <li class="fw-bold mt-2 text-danger"><i class="fas fa-calendar-check me-2"></i>Prochaine disponibilité : {{ \Carbon\Carbon::parse($residence->date_disponible)->translatedFormat('d F Y') }}</li>
                                </ul>
                                <a href="{{ route('details', $residence->id) }}" class="btn btn-dark rounded mt-auto">Voir les Détails <i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                @endforeach
...
<footer id="contact">
    <p>&copy; 2025 Afrik’Hub. Tous droits réservés.<br>afrikhub@gmail.com</p>
</footer>
@endsection
